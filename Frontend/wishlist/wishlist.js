...
let databaseArray = [
  {
    id: 1,
    Title: "Sleek Gold Bangle",
    Description:
      "Choose simplicity and elegance with this minimally designed sleek gold bangle, meticulously crafted in 22 karat yellow gold.",
    Type: "Bangle",
    Weight: "10.268 g",
    Price: 75196,
    DiscountPrice: 72550,
    Img: [
      "https://www.tanishq.co.in/dw/image/v2/BKCK_PRD/on/demandware.static/-/Sites-Tanishq-product-catalog/default/dw83070ddd/images/hi-res/510228VEA1A00_1.jpg?sw=115&sh=115",
      
    ],
    Brand: "Tanishq",
  }
];
function invoke(databaseArray){
  let wishlistItem = JSON.parse(localStorage.getItem("wishlistItem")) || [];
let mergArr=[...wishlistItem,...databaseArray];

localStorage.setItem("wishlistItem", JSON.stringify(mergArr));
}
invoke(databaseArray);
